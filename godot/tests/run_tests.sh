...
SCENES=(
  # Add test scenes here as they are created, e.g.:
  # "tests/SuitConfigurationTest.tscn"
  # "tests/SuitStatsTest.tscn"
  # "tests/WorldStateManagerTest.tscn"
)

if [[ ${#SCENES[@]} -eq 0 ]]; then
  echo "No test scenes registered yet. Add them to SCENES in run_tests.sh."
  exit 0
fi
